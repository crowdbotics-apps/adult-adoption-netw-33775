...
## Project Structure
    ...
    ├── adult_adoption_netw_33775  # Django project configurations
...
1. Clone this repo and `cd adult_adoption_netw_33775`
...
2. Clone this repo and `cd adult_adoption_netw_33775`
